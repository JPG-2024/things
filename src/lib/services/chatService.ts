...
import { getChatById, getMessagesByChat, saveMessage } from "@/lib/utils/database/chatDB"
...
import type { ChatMessageUI, DBChatMessage } from "@/types/chat.types"
...
export class ChatService {
	...
	async initialize(fullContent: boolean = false): Promise<ChatMessageUI[]> {
		...
		for (const msg of dbMessages) {
			...
			this.conversationManager.addMessage(ollamaMsg.role, ollamaMsg.content)
		}
